...
trap_init(void)
{
	...
	extern void F_DIVIDE_G();
	extern void F_DEBUG_G();
	extern void F_NMI_G();
	extern void F_BRKPT_G();
	extern void F_OFLOW_G();
	extern void F_BOUND_G();
	extern void F_ILLOP_G();
	extern void F_DEVICE_G();
	extern void F_DBLFLT_G();
	extern void F_TSS_G();
	extern void F_SEGNP_G();
	extern void F_STACK_G();
	extern void F_GPFLT_G();
	extern void F_PGFLT_G();
	extern void F_FPERR_G();
	extern void F_ALIGN_G();
	extern void F_MCHK_G();
	extern void F_SIMDERR_G();
	extern void F_SYSCALL_G();
	extern void F_DEFAULT_G();
	extern void IRQ_NUMBER_1();
	extern void IRQ_NUMBER_2();
	extern void IRQ_NUMBER_3();
...
trap_dispatch(struct Trapframe *tf)
{
	...
	case T_SYSCALL:
		tf->tf_regs.reg_eax = syscall(
		        tf->tf_regs.reg_eax,  // Convention: Syscall number
		                              // goes first (AX), then DX, CX, BX, DI, SI.
		        tf->tf_regs.reg_edx,
		        tf->tf_regs.reg_ecx,
		        tf->tf_regs.reg_ebx,
		        tf->tf_regs.reg_edi,
