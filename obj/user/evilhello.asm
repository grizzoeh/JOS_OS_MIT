...
00800a4b <devfile_read>:
{
  ...
  800aa4:	c3                   	ret    
	assert(r <= n);
  800aa5:	68 a4 1e 80 00       	push   $0x801ea4
  800aaa:	68 ab 1e 80 00       	push   $0x801eab
  800aaf:	6a 7c                	push   $0x7c
  800ab1:	68 c0 1e 80 00       	push   $0x801ec0
  800ab6:	e8 be 05 00 00       	call   801079 <_panic>
	assert(r <= PGSIZE);
  800abb:	68 cb 1e 80 00       	push   $0x801ecb
  800ac0:	68 ab 1e 80 00       	push   $0x801eab
  800ac5:	6a 7d                	push   $0x7d
  800ac7:	68 c0 1e 80 00       	push   $0x801ec0
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800b9a:	68 d7 1e 80 00       	push   $0x801ed7
  800b9f:	53                   	push   %ebx
...
00800bfe <_pipeisclosed>:
{
  ...
  800c41:	50                   	push   %eax
  800c42:	53                   	push   %ebx
  800c43:	68 de 1e 80 00       	push   $0x801ede
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800ef8:	68 f6 1e 80 00       	push   $0x801ef6
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801099:	56                   	push   %esi
  80109a:	50                   	push   %eax
  80109b:	68 04 1f 80 00       	push   $0x801f04
  ...
  8010ac:	e8 5a 00 00 00       	call   80110b <vcprintf>
	cprintf("\n");
  8010b1:	c7 04 24 ef 1e 80 00 	movl   $0x801eef,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80120c:	0f be 80 27 1f 80 00 	movsbl 0x801f27(%eax),%eax
  801213:	50                   	push   %eax
...
008012c3 <vprintfmt>:
{
  ...
  8013eb:	52                   	push   %edx
  8013ec:	68 bd 1e 80 00       	push   $0x801ebd
  8013f1:	56                   	push   %esi
  8013f2:	53                   	push   %ebx
  ...
  801400:	50                   	push   %eax
  801401:	68 3f 1f 80 00       	push   $0x801f3f
  801406:	56                   	push   %esi
  801407:	53                   	push   %ebx
  ...
  801422:	b8 38 1f 80 00       	mov    $0x801f38,%eax
