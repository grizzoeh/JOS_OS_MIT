...
umain(int argc, char **argv)
{
  ...
  80009a:	79 25                	jns    8000c1 <umain+0x8e>
		panic("dup: %e", r);
  80009c:	50                   	push   %eax
  80009d:	68 d6 20 80 00       	push   $0x8020d6
  8000a2:	6a 13                	push   $0x13
  8000a4:	68 ad 20 80 00       	push   $0x8020ad
  ...
  8000b1:	50                   	push   %eax
  8000b2:	68 ec 20 80 00       	push   $0x8020ec
  8000b7:	6a 01                	push   $0x1
  8000b9:	e8 98 18 00 00       	call   801956 <fprintf>
  8000be:	83 c4 10             	add    $0x10,%esp
		buf = readline("Type a line: ");
  8000c1:	83 ec 0c             	sub    $0xc,%esp
  8000c4:	68 de 20 80 00       	push   $0x8020de
  ...
  8000df:	e8 72 18 00 00       	call   801956 <fprintf>
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8000fd:	68 08 21 80 00       	push   $0x802108
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80030a:	56                   	push   %esi
  80030b:	50                   	push   %eax
  80030c:	68 20 21 80 00       	push   $0x802120
  ...
  80031d:	e8 5a 00 00 00       	call   80037c <vcprintf>
	cprintf("\n");
  800322:	c7 04 24 06 21 80 00 	movl   $0x802106,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800437:	e8 f4 19 00 00       	call   801e30 <__udivdi3>
  ...
  800475:	e8 c6 1a 00 00       	call   801f40 <__umoddi3>
  80047a:	83 c4 14             	add    $0x14,%esp
  80047d:	0f be 80 43 21 80 00 	movsbl 0x802143(%eax),%eax
  800484:	50                   	push   %eax
...
00800534 <vprintfmt>:
{
  ...
  800584:	3e ff 24 85 80 22 80 	notrack jmp *0x802280(,%eax,4)
  80058b:	00 
  ...
  800651:	8b 14 85 e0 23 80 00 	mov    0x8023e0(,%eax,4),%edx
  800658:	85 d2                	test   %edx,%edx
  80065a:	74 15                	je     800671 <vprintfmt+0x13d>
				printfmt(putch, putdat, "%s", p);
  80065c:	52                   	push   %edx
  80065d:	68 21 25 80 00       	push   $0x802521
  800662:	56                   	push   %esi
  800663:	53                   	push   %ebx
  ...
  800671:	50                   	push   %eax
  800672:	68 5b 21 80 00       	push   $0x80215b
  800677:	56                   	push   %esi
  800678:	53                   	push   %ebx
  ...
  800693:	b8 54 21 80 00       	mov    $0x802154,%eax
...
readline(const char *prompt)
{
  ...
  80090f:	50                   	push   %eax
  800910:	68 21 25 80 00       	push   $0x802521
  800915:	6a 01                	push   $0x1
  800917:	e8 3a 10 00 00       	call   801956 <fprintf>
  ...
  80094a:	53                   	push   %ebx
  80094b:	68 3f 24 80 00       	push   $0x80243f
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800ddb:	68 4f 24 80 00       	push   $0x80244f
  800de0:	6a 23                	push   $0x23
  800de2:	68 6c 24 80 00       	push   $0x80246c
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  8010de:	ba f8 24 80 00       	mov    $0x8024f8,%edx
	int i;
	for (i = 0; devtab[i]; i++)
  ...
  801100:	51                   	push   %ecx
  801101:	50                   	push   %eax
  801102:	68 7c 24 80 00       	push   $0x80247c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80136e:	53                   	push   %ebx
  80136f:	50                   	push   %eax
  801370:	68 bd 24 80 00       	push   $0x8024bd
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  80143f:	53                   	push   %ebx
  801440:	50                   	push   %eax
  801441:	68 d9 24 80 00       	push   $0x8024d9
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8014ef:	53                   	push   %ebx
  8014f0:	50                   	push   %eax
  8014f1:	68 9c 24 80 00       	push   $0x80249c
...
stat(const char *path, struct Stat *stat)
{
  ...
  801595:	e8 20 02 00 00       	call   8017ba <open>
...
fsipc(unsigned type, void *dstva)
{
  ...
  8015e7:	e8 72 07 00 00       	call   801d5e <ipc_send>
	return ipc_recv(NULL, dstva, NULL);
  8015ec:	83 c4 0c             	add    $0xc,%esp
  8015ef:	6a 00                	push   $0x0
  8015f1:	53                   	push   %ebx
  8015f2:	6a 00                	push   $0x0
  8015f4:	e8 f8 06 00 00       	call   801cf1 <ipc_recv>
}
  ...
  801605:	e8 a7 07 00 00       	call   801db1 <ipc_find_env>
...
008016c5 <devfile_write>:
{
  ...
  8016e8:	bf f8 0f 00 00       	mov    $0xff8,%edi
	while (n > 0) {
  8016ed:	85 db                	test   %ebx,%ebx
  8016ef:	74 3b                	je     80172c <devfile_write+0x67>
		fsipcbuf.write.req_n = MIN(n, sizeof(fsipcbuf.write.req_buf));
  8016f1:	81 fb f8 0f 00 00    	cmp    $0xff8,%ebx
  8016f7:	89 f8                	mov    %edi,%eax
  8016f9:	0f 46 c3             	cmovbe %ebx,%eax
  ...
  801704:	50                   	push   %eax
  801705:	56                   	push   %esi
  801706:	68 08 50 80 00       	push   $0x805008
  80170b:	e8 d7 f4 ff ff       	call   800be7 <memmove>
		if ((r = fsipc(FSREQ_WRITE, NULL)) < 0) {
  801710:	ba 00 00 00 00       	mov    $0x0,%edx
  801715:	b8 04 00 00 00       	mov    $0x4,%eax
  80171a:	e8 a8 fe ff ff       	call   8015c7 <fsipc>
  80171f:	83 c4 10             	add    $0x10,%esp
  801722:	85 c0                	test   %eax,%eax
  801724:	78 06                	js     80172c <devfile_write+0x67>
		buf_aux += r;
  801726:	01 c6                	add    %eax,%esi
		n -= r;
  801728:	29 c3                	sub    %eax,%ebx
  80172a:	eb c1                	jmp    8016ed <devfile_write+0x28>
}
...
00801734 <devfile_read>:
{
  ...
  80178d:	c3                   	ret    
	assert(r <= n);
  80178e:	68 08 25 80 00       	push   $0x802508
  801793:	68 0f 25 80 00       	push   $0x80250f
  801798:	6a 7c                	push   $0x7c
  80179a:	68 24 25 80 00       	push   $0x802524
  80179f:	e8 46 eb ff ff       	call   8002ea <_panic>
	assert(r <= PGSIZE);
  8017a4:	68 2f 25 80 00       	push   $0x80252f
  8017a9:	68 0f 25 80 00       	push   $0x80250f
  8017ae:	6a 7d                	push   $0x7d
  8017b0:	68 24 25 80 00       	push   $0x802524
  8017b5:	e8 30 eb ff ff       	call   8002ea <_panic>
...
008017ba <open>:
{
  ...
  80180c:	e8 b6 fd ff ff       	call   8015c7 <fsipc>
  801811:	89 c3                	mov    %eax,%ebx
  801813:	83 c4 10             	add    $0x10,%esp
  801816:	85 c0                	test   %eax,%eax
  801818:	78 19                	js     801833 <open+0x79>
	return fd2num(fd);
  80181a:	83 ec 0c             	sub    $0xc,%esp
  80181d:	ff 75 f4             	pushl  -0xc(%ebp)
  801820:	e8 cf f7 ff ff       	call   800ff4 <fd2num>
  ...
  80183b:	e8 eb f8 ff ff       	call   80112b <fd_close>
		return r;
  801840:	83 c4 10             	add    $0x10,%esp
  801843:	eb e5                	jmp    80182a <open+0x70>
		return -E_BAD_PATH;
  801845:	bb f4 ff ff ff       	mov    $0xfffffff4,%ebx
  80184a:	eb de                	jmp    80182a <open+0x70>
...
sync(void)
{
  ...
  801860:	e8 62 fd ff ff       	call   8015c7 <fsipc>
}
  801865:	c9                   	leave  
  801866:	c3                   	ret    
...
writebuf(struct printbuf *b)
{
  ...
  80186b:	7f 01                	jg     80186e <writebuf+0x7>
  80186d:	c3                   	ret    
{
  80186e:	55                   	push   %ebp
  ...
  801877:	ff 70 04             	pushl  0x4(%eax)
  80187a:	8d 40 10             	lea    0x10(%eax),%eax
  80187d:	50                   	push   %eax
  80187e:	ff 33                	pushl  (%ebx)
  801880:	e8 51 fb ff ff       	call   8013d6 <write>
		if (result > 0)
  801885:	83 c4 10             	add    $0x10,%esp
  801888:	85 c0                	test   %eax,%eax
  80188a:	7e 03                	jle    80188f <writebuf+0x28>
			b->result += result;
  80188c:	01 43 08             	add    %eax,0x8(%ebx)
		if (result != b->idx) // error, or wrote less than supplied
  80188f:	39 43 04             	cmp    %eax,0x4(%ebx)
  801892:	74 0d                	je     8018a1 <writebuf+0x3a>
			b->error = (result < 0 ? result : 0);
  801894:	85 c0                	test   %eax,%eax
  801896:	ba 00 00 00 00       	mov    $0x0,%edx
  80189b:	0f 4f c2             	cmovg  %edx,%eax
  80189e:	89 43 0c             	mov    %eax,0xc(%ebx)
	}
}
...
putch(int ch, void *thunk)
{
  ...
  8018b1:	8b 5d 0c             	mov    0xc(%ebp),%ebx
	...
	b->buf[b->idx++] = ch;
  8018b4:	8b 53 04             	mov    0x4(%ebx),%edx
  8018b7:	8d 42 01             	lea    0x1(%edx),%eax
  8018ba:	89 43 04             	mov    %eax,0x4(%ebx)
  8018bd:	8b 4d 08             	mov    0x8(%ebp),%ecx
  8018c0:	88 4c 13 10          	mov    %cl,0x10(%ebx,%edx,1)
	if (b->idx == 256) {
  8018c4:	3d 00 01 00 00       	cmp    $0x100,%eax
  8018c9:	74 06                	je     8018d1 <putch+0x2b>
		writebuf(b);
		b->idx = 0;
	}
}
  ...
  8018d3:	e8 8f ff ff ff       	call   801867 <writebuf>
		b->idx = 0;
  8018d8:	c7 43 04 00 00 00 00 	movl   $0x0,0x4(%ebx)
}
  8018df:	eb ea                	jmp    8018cb <putch+0x25>
...
vfprintf(int fd, const char *fmt, va_list ap)
{
  ...
  8018e8:	81 ec 18 01 00 00    	sub    $0x118,%esp
	struct printbuf b;

	b.fd = fd;
  8018ee:	8b 45 08             	mov    0x8(%ebp),%eax
  8018f1:	89 85 e8 fe ff ff    	mov    %eax,-0x118(%ebp)
	b.idx = 0;
  8018f7:	c7 85 ec fe ff ff 00 	movl   $0x0,-0x114(%ebp)
  8018fe:	00 00 00 
	b.result = 0;
  801901:	c7 85 f0 fe ff ff 00 	movl   $0x0,-0x110(%ebp)
  801908:	00 00 00 
	b.error = 1;
  80190b:	c7 85 f4 fe ff ff 01 	movl   $0x1,-0x10c(%ebp)
  801912:	00 00 00 
	vprintfmt(putch, &b, fmt, ap);
  801915:	ff 75 10             	pushl  0x10(%ebp)
  801918:	ff 75 0c             	pushl  0xc(%ebp)
  80191b:	8d 85 e8 fe ff ff    	lea    -0x118(%ebp),%eax
  801921:	50                   	push   %eax
  801922:	68 a6 18 80 00       	push   $0x8018a6
  801927:	e8 08 ec ff ff       	call   800534 <vprintfmt>
	if (b.idx > 0)
  80192c:	83 c4 10             	add    $0x10,%esp
  80192f:	83 bd ec fe ff ff 00 	cmpl   $0x0,-0x114(%ebp)
  801936:	7f 11                	jg     801949 <vfprintf+0x68>
		writebuf(&b);

	return (b.result ? b.result : b.error);
  801938:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
  80193e:	85 c0                	test   %eax,%eax
  801940:	0f 44 85 f4 fe ff ff 	cmove  -0x10c(%ebp),%eax
}
  801947:	c9                   	leave  
  801948:	c3                   	ret    
		writebuf(&b);
  801949:	8d 85 e8 fe ff ff    	lea    -0x118(%ebp),%eax
  80194f:	e8 13 ff ff ff       	call   801867 <writebuf>
  801954:	eb e2                	jmp    801938 <vfprintf+0x57>
...
fprintf(int fd, const char *fmt, ...)
{
  ...
  80195d:	83 ec 0c             	sub    $0xc,%esp
	...
	va_start(ap, fmt);
  801960:	8d 45 10             	lea    0x10(%ebp),%eax
	cnt = vfprintf(fd, fmt, ap);
  801963:	50                   	push   %eax
  801964:	ff 75 0c             	pushl  0xc(%ebp)
  801967:	ff 75 08             	pushl  0x8(%ebp)
  80196a:	e8 72 ff ff ff       	call   8018e1 <vfprintf>
	va_end(ap);
...
printf(const char *fmt, ...)
{
  ...
  801978:	83 ec 0c             	sub    $0xc,%esp
	...
	va_start(ap, fmt);
  80197b:	8d 45 0c             	lea    0xc(%ebp),%eax
	cnt = vfprintf(1, fmt, ap);
  80197e:	50                   	push   %eax
  80197f:	ff 75 08             	pushl  0x8(%ebp)
  801982:	6a 01                	push   $0x1
  801984:	e8 58 ff ff ff       	call   8018e1 <vfprintf>
	va_end(ap);
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80199d:	e8 66 f6 ff ff       	call   801008 <fd2data>
  8019a2:	89 c6                	mov    %eax,%esi
	strcpy(stat->st_name, "<pipe>");
  8019a4:	83 c4 08             	add    $0x8,%esp
  8019a7:	68 3b 25 80 00       	push   $0x80253b
  8019ac:	53                   	push   %ebx
  8019ad:	e8 7d f0 ff ff       	call   800a2f <strcpy>
	stat->st_size = p->p_wpos - p->p_rpos;
  8019b2:	8b 46 04             	mov    0x4(%esi),%eax
  8019b5:	2b 06                	sub    (%esi),%eax
  8019b7:	89 83 80 00 00 00    	mov    %eax,0x80(%ebx)
	stat->st_isdir = 0;
  8019bd:	c7 83 84 00 00 00 00 	movl   $0x0,0x84(%ebx)
  8019c4:	00 00 00 
	stat->st_dev = &devpipe;
  8019c7:	c7 83 88 00 00 00 3c 	movl   $0x80303c,0x88(%ebx)
  8019ce:	30 80 00 
	return 0;
}
...
devpipe_close(struct Fd *fd)
{
  ...
  8019ee:	e8 16 f5 ff ff       	call   800f09 <sys_page_unmap>
	return sys_page_unmap(0, fd2data(fd));
  8019f3:	89 1c 24             	mov    %ebx,(%esp)
  8019f6:	e8 0d f6 ff ff       	call   801008 <fd2data>
  8019fb:	83 c4 08             	add    $0x8,%esp
  8019fe:	50                   	push   %eax
  8019ff:	6a 00                	push   $0x0
  801a01:	e8 03 f5 ff ff       	call   800f09 <sys_page_unmap>
}
...
00801a0b <_pipeisclosed>:
{
  ...
  801a16:	89 d6                	mov    %edx,%esi
		n = thisenv->env_runs;
  801a18:	a1 04 44 80 00       	mov    0x804404,%eax
  801a1d:	8b 58 58             	mov    0x58(%eax),%ebx
		ret = pageref(fd) == pageref(p);
  801a20:	83 ec 0c             	sub    $0xc,%esp
  801a23:	57                   	push   %edi
  801a24:	e8 c5 03 00 00       	call   801dee <pageref>
  801a29:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  801a2c:	89 34 24             	mov    %esi,(%esp)
  801a2f:	e8 ba 03 00 00       	call   801dee <pageref>
		nn = thisenv->env_runs;
  801a34:	8b 15 04 44 80 00    	mov    0x804404,%edx
  801a3a:	8b 4a 58             	mov    0x58(%edx),%ecx
		if (n == nn)
  801a3d:	83 c4 10             	add    $0x10,%esp
  801a40:	39 cb                	cmp    %ecx,%ebx
  801a42:	74 1b                	je     801a5f <_pipeisclosed+0x54>
		if (n != nn && ret == 1)
  801a44:	39 45 e4             	cmp    %eax,-0x1c(%ebp)
  801a47:	75 cf                	jne    801a18 <_pipeisclosed+0xd>
			cprintf("pipe race avoided\n", n, thisenv->env_runs, ret);
  801a49:	8b 42 58             	mov    0x58(%edx),%eax
  801a4c:	6a 01                	push   $0x1
  801a4e:	50                   	push   %eax
  801a4f:	53                   	push   %ebx
  801a50:	68 42 25 80 00       	push   $0x802542
  801a55:	e8 77 e9 ff ff       	call   8003d1 <cprintf>
  801a5a:	83 c4 10             	add    $0x10,%esp
  801a5d:	eb b9                	jmp    801a18 <_pipeisclosed+0xd>
		ret = pageref(fd) == pageref(p);
  801a5f:	39 45 e4             	cmp    %eax,-0x1c(%ebp)
...
00801a70 <devpipe_write>:
{
  ...
  801a80:	56                   	push   %esi
  801a81:	e8 82 f5 ff ff       	call   801008 <fd2data>
  801a86:	89 c3                	mov    %eax,%ebx
	for (i = 0; i < n; i++) {
  801a88:	83 c4 10             	add    $0x10,%esp
  801a8b:	bf 00 00 00 00       	mov    $0x0,%edi
  801a90:	3b 7d 10             	cmp    0x10(%ebp),%edi
  801a93:	74 4f                	je     801ae4 <devpipe_write+0x74>
		while (p->p_wpos >= p->p_rpos + sizeof(p->p_buf)) {
  801a95:	8b 43 04             	mov    0x4(%ebx),%eax
  801a98:	8b 0b                	mov    (%ebx),%ecx
  801a9a:	8d 51 20             	lea    0x20(%ecx),%edx
  801a9d:	39 d0                	cmp    %edx,%eax
  801a9f:	72 14                	jb     801ab5 <devpipe_write+0x45>
			if (_pipeisclosed(fd, p))
  801aa1:	89 da                	mov    %ebx,%edx
  801aa3:	89 f0                	mov    %esi,%eax
  801aa5:	e8 61 ff ff ff       	call   801a0b <_pipeisclosed>
  801aaa:	85 c0                	test   %eax,%eax
  801aac:	75 3b                	jne    801ae9 <devpipe_write+0x79>
			sys_yield();
  801aae:	e8 d9 f3 ff ff       	call   800e8c <sys_yield>
  801ab3:	eb e0                	jmp    801a95 <devpipe_write+0x25>
  ...
  801ae2:	eb ac                	jmp    801a90 <devpipe_write+0x20>
	return i;
  801ae4:	8b 45 10             	mov    0x10(%ebp),%eax
  801ae7:	eb 05                	jmp    801aee <devpipe_write+0x7e>
				return 0;
...
00801af6 <devpipe_read>:
{
  ...
  801b03:	8b 7d 08             	mov    0x8(%ebp),%edi
	p = (struct Pipe*)fd2data(fd);
  801b06:	57                   	push   %edi
  801b07:	e8 fc f4 ff ff       	call   801008 <fd2data>
  801b0c:	89 c3                	mov    %eax,%ebx
	for (i = 0; i < n; i++) {
  801b0e:	83 c4 10             	add    $0x10,%esp
  801b11:	be 00 00 00 00       	mov    $0x0,%esi
  801b16:	3b 75 10             	cmp    0x10(%ebp),%esi
  801b19:	75 14                	jne    801b2f <devpipe_read+0x39>
	return i;
  801b1b:	8b 45 10             	mov    0x10(%ebp),%eax
  801b1e:	eb 02                	jmp    801b22 <devpipe_read+0x2c>
				return i;
  ...
  801b29:	c3                   	ret    
			sys_yield();
  801b2a:	e8 5d f3 ff ff       	call   800e8c <sys_yield>
		while (p->p_rpos == p->p_wpos) {
  801b2f:	8b 03                	mov    (%ebx),%eax
  801b31:	3b 43 04             	cmp    0x4(%ebx),%eax
  801b34:	75 18                	jne    801b4e <devpipe_read+0x58>
			if (i > 0)
  801b36:	85 f6                	test   %esi,%esi
  801b38:	75 e6                	jne    801b20 <devpipe_read+0x2a>
			if (_pipeisclosed(fd, p))
  801b3a:	89 da                	mov    %ebx,%edx
  801b3c:	89 f8                	mov    %edi,%eax
  801b3e:	e8 c8 fe ff ff       	call   801a0b <_pipeisclosed>
  801b43:	85 c0                	test   %eax,%eax
  801b45:	74 e3                	je     801b2a <devpipe_read+0x34>
				return 0;
  801b47:	b8 00 00 00 00       	mov    $0x0,%eax
  801b4c:	eb d4                	jmp    801b22 <devpipe_read+0x2c>
  ...
  801b59:	0f b6 44 03 08       	movzbl 0x8(%ebx,%eax,1),%eax
  801b5e:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  801b61:	88 04 31             	mov    %al,(%ecx,%esi,1)
		p->p_rpos++;
  801b64:	83 03 01             	addl   $0x1,(%ebx)
	for (i = 0; i < n; i++) {
  801b67:	83 c6 01             	add    $0x1,%esi
  801b6a:	eb aa                	jmp    801b16 <devpipe_read+0x20>
...
00801cba <pipeisclosed>:
{
  ...
  801ccb:	e8 ad f3 ff ff       	call   80107d <fd_lookup>
  801cd0:	83 c4 10             	add    $0x10,%esp
  801cd3:	85 c0                	test   %eax,%eax
  801cd5:	78 18                	js     801cef <pipeisclosed+0x35>
	p = (struct Pipe*) fd2data(fd);
  801cd7:	83 ec 0c             	sub    $0xc,%esp
  801cda:	ff 75 f4             	pushl  -0xc(%ebp)
  801cdd:	e8 26 f3 ff ff       	call   801008 <fd2data>
  801ce2:	89 c2                	mov    %eax,%edx
	return _pipeisclosed(fd, p);
  801ce4:	8b 45 f4             	mov    -0xc(%ebp),%eax
  801ce7:	e8 1f fd ff ff       	call   801a0b <_pipeisclosed>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801d05:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  801d0a:	0f 44 c2             	cmove  %edx,%eax
	}

	int f = sys_ipc_recv(pg);
  801d0d:	83 ec 0c             	sub    $0xc,%esp
  801d10:	50                   	push   %eax
  801d11:	e8 b8 f2 ff ff       	call   800fce <sys_ipc_recv>
	if (f < 0) {
  801d16:	83 c4 10             	add    $0x10,%esp
  801d19:	85 c0                	test   %eax,%eax
  801d1b:	78 2b                	js     801d48 <ipc_recv+0x57>
			*perm_store = 0;
		}
		return f;
	}
  ...
  801d1f:	74 0a                	je     801d2b <ipc_recv+0x3a>
		*from_env_store = thisenv->env_ipc_from;
  801d21:	a1 04 44 80 00       	mov    0x804404,%eax
  801d26:	8b 40 74             	mov    0x74(%eax),%eax
  801d29:	89 06                	mov    %eax,(%esi)
	}
	if (perm_store != NULL) {
  801d2b:	85 db                	test   %ebx,%ebx
  801d2d:	74 0a                	je     801d39 <ipc_recv+0x48>
		*perm_store = thisenv->env_ipc_perm;
  801d2f:	a1 04 44 80 00       	mov    0x804404,%eax
  801d34:	8b 40 78             	mov    0x78(%eax),%eax
  801d37:	89 03                	mov    %eax,(%ebx)
	}

	return thisenv->env_ipc_value;
  801d39:	a1 04 44 80 00       	mov    0x804404,%eax
  ...
  801d4a:	74 06                	je     801d52 <ipc_recv+0x61>
			*from_env_store = 0;
  801d4c:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
		if (perm_store != NULL) {
  801d52:	85 db                	test   %ebx,%ebx
  801d54:	74 eb                	je     801d41 <ipc_recv+0x50>
			*perm_store = 0;
  801d56:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  801d5c:	eb e3                	jmp    801d41 <ipc_recv+0x50>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801d6e:	8b 75 0c             	mov    0xc(%ebp),%esi
  801d71:	8b 5d 10             	mov    0x10(%ebp),%ebx
	// LAB 4: Your code here.
	if (pg == NULL) {
		pg = (void *) -1;
  801d74:	85 db                	test   %ebx,%ebx
  801d76:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  801d7b:	0f 44 d8             	cmove  %eax,%ebx
	}
  ...
  801d82:	56                   	push   %esi
  801d83:	57                   	push   %edi
  801d84:	e8 1c f2 ff ff       	call   800fa5 <sys_ipc_try_send>
  801d89:	83 c4 10             	add    $0x10,%esp
  801d8c:	85 c0                	test   %eax,%eax
  801d8e:	79 19                	jns    801da9 <ipc_send+0x4b>
		if (f != -E_IPC_NOT_RECV) {
  801d90:	83 f8 f9             	cmp    $0xfffffff9,%eax
  801d93:	74 e9                	je     801d7e <ipc_send+0x20>
			panic("ipc_send: sys_ipc_try_send failed");
  801d95:	83 ec 04             	sub    $0x4,%esp
  801d98:	68 5c 25 80 00       	push   $0x80255c
  801d9d:	6a 48                	push   $0x48
  801d9f:	68 7e 25 80 00       	push   $0x80257e
  801da4:	e8 41 e5 ff ff       	call   8002ea <_panic>
		}
	}
}
...
ipc_find_env(enum EnvType type)
{
  ...
  801dce:	74 11                	je     801de1 <ipc_find_env+0x30>
	for (i = 0; i < NENV; i++)
  801dd0:	83 c0 01             	add    $0x1,%eax
  801dd3:	3d 00 04 00 00       	cmp    $0x400,%eax
  801dd8:	75 e6                	jne    801dc0 <ipc_find_env+0xf>
			return envs[i].env_id;
	return 0;
  801dda:	b8 00 00 00 00       	mov    $0x0,%eax
  801ddf:	eb 0b                	jmp    801dec <ipc_find_env+0x3b>
			return envs[i].env_id;
  801de1:	6b c0 7c             	imul   $0x7c,%eax,%eax
  801de4:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  801de9:	8b 40 48             	mov    0x48(%eax),%eax
}
  801dec:	5d                   	pop    %ebp
  801ded:	c3                   	ret    
...
pageref(void *v)
{
  ...
  801dfa:	c1 ea 16             	shr    $0x16,%edx
  801dfd:	8b 0c 95 00 d0 7b ef 	mov    -0x10843000(,%edx,4),%ecx
		return 0;
  801e04:	ba 00 00 00 00       	mov    $0x0,%edx
	if (!(uvpd[PDX(v)] & PTE_P))
  801e09:	f6 c1 01             	test   $0x1,%cl
  801e0c:	74 1c                	je     801e2a <pageref+0x3c>
	pte = uvpt[PGNUM(v)];
  801e0e:	c1 e8 0c             	shr    $0xc,%eax
  801e11:	8b 04 85 00 00 40 ef 	mov    -0x10c00000(,%eax,4),%eax
	if (!(pte & PTE_P))
  801e18:	a8 01                	test   $0x1,%al
  801e1a:	74 0e                	je     801e2a <pageref+0x3c>
		return 0;
	return pages[PGNUM(pte)].pp_ref;
  801e1c:	c1 e8 0c             	shr    $0xc,%eax
  801e1f:	0f b7 14 c5 04 00 00 	movzwl -0x10fffffc(,%eax,8),%edx
  801e26:	ef 
  801e27:	0f b7 d2             	movzwl %dx,%edx
}
