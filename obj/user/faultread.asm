...
008013ca <devfile_read>:
{
  ...
  801423:	c3                   	ret    
	assert(r <= n);
  801424:	68 b8 21 80 00       	push   $0x8021b8
  801429:	68 bf 21 80 00       	push   $0x8021bf
  80142e:	6a 7c                	push   $0x7c
  801430:	68 d4 21 80 00       	push   $0x8021d4
  801435:	e8 be 05 00 00       	call   8019f8 <_panic>
	assert(r <= PGSIZE);
  80143a:	68 df 21 80 00       	push   $0x8021df
  80143f:	68 bf 21 80 00       	push   $0x8021bf
  801444:	6a 7d                	push   $0x7d
  801446:	68 d4 21 80 00       	push   $0x8021d4
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801519:	68 eb 21 80 00       	push   $0x8021eb
  80151e:	53                   	push   %ebx
...
0080157d <_pipeisclosed>:
{
  ...
  8015c0:	50                   	push   %eax
  8015c1:	53                   	push   %ebx
  8015c2:	68 f2 21 80 00       	push   $0x8021f2
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801877:	68 0a 22 80 00       	push   $0x80220a
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801a18:	56                   	push   %esi
  801a19:	50                   	push   %eax
  801a1a:	68 18 22 80 00       	push   $0x802218
  ...
  801a2b:	e8 d6 e6 ff ff       	call   800106 <vcprintf>
	cprintf("\n");
  801a30:	c7 04 24 fc 1d 80 00 	movl   $0x801dfc,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801ae9:	68 3c 22 80 00       	push   $0x80223c
  801aee:	6a 48                	push   $0x48
  801af0:	68 5e 22 80 00       	push   $0x80225e
